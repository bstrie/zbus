...
use crate::{BusName, Error, InterfaceName, MessageField, MessageFieldCode, MessageFields, UniqueName};
...
#[cfg(test)]
mod tests {
    use crate::{InterfaceName, MessageField, MessageFields, MessageHeader, MessagePrimaryHeader, MessageType};
    ...
    fn header() -> Result<(), Box<dyn Error>> {
        ...
        f.add(MessageField::Interface(iface));
